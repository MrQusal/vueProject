  ...
  <div class="pay-main">
    <div class="pay-container">
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money">￥{{ payInfo.payInfo }}</em></span
          >
        </div>
      </div>
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a href="#" class="btn" @click.prevent="showPaymentCode">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  computed: {
    // 从路由参数中获取订单号
    orderId() {
      return this.$route.query.orderId || undefined;
    },
  },
};
</script>
