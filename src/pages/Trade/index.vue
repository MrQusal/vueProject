  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ checkedAddress.userAddress }}</span>
        收货人：<span>{{ checkedAddress.consignee }}</span> 手机号：<span>{{
          checkedAddress.phoneNum
        }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a class="subBtn" href="#" @click.prevent="submitOrder">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapActions("trade", ["getUserAddressList", "getOrders"]),
    // 修改默认地址
    ...
    submitOrder() {
      ...
      // 其余六个参数
      const data = {
        consignee: this.checkedAddress.consignee, // 收件人姓名
        consigneeTel: this.checkedAddress.phoneNum, // 收件人手机号
        deliveryAddress: this.checkedAddress.fullAddress, // 收件人地址
