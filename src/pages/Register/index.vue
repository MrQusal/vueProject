    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ isvalid: errors.has('phone') }"
        />
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ isvalid: errors.has('password') }"
        />
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ isvalid: errors.has('passwordConfirm') }"
        />
      ...
      <div class="controls">
        <input
          ...
          :class="{ isvalid: errors.has('agree') }"
        />
...
export default {
  ...
  methods: {
    ...
    async handlerRegister() {
      let flag = await this.$validator.validateAll();
      console.log(flag);
      if (!flag) {
        return this.$message({
          type: "info",
